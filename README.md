...
| 4 | [CVE-2026-54236](https://github.com/vllm-project/vllm/security/advisories/GHSA-hgg8-fqqc-vfmw) | vLLM | Incomplete CVE-2026-22778 Fix → PIL repr ASLR-Bypass Infoleak via Anthropic Router (CWE-532) | Medium (5.3) | Published |
| 5 | [CVE-2026-43121](https://nvd.nist.gov/vuln/detail/CVE-2026-43121) | Linux Kernel io_uring | `user_ref` race → double-free → OOB write | Medium (4.7) | Published |
| 6 | [CVE-2026-46132](https://www.cve.org/CVERecord?id=CVE-2026-46132) | Linux Kernel net/rtnetlink | `ifla_vf_broadcast` stack infoleak via Netlink RTM_GETLINK | Low | Published |
| 7 | [CVE-2026-3288](https://nvd.nist.gov/vuln/detail/CVE-2026-3288) | Kubernetes ingress-nginx | Config Injection → RCE | **High (8.8)** | Published |
| 8 | [CVE-2026-30911](https://nvd.nist.gov/vuln/detail/CVE-2026-30911) | Apache Airflow Core | Missing Auth (HITL) | **High (8.1)** | Published |
| 9 | [CVE-2026-32794](https://nvd.nist.gov/vuln/detail/CVE-2026-32794) | Apache Airflow (Databricks Provider) | TLS Verification Bypass → MitM | Medium (4.8) | Published |
| 10 | [CVE-2026-8368](https://github.com/libwww-perl/libwww-perl/pull/512) | Perl `LWP::UserAgent` / `HTTP::Tiny` | Zero Header Strip on Cross-Host Redirect | — | NVD: RESERVED |
| 11 | [CVE-2026-45363](https://github.com/jwt/ruby-jwt/security/advisories/GHSA-c32j-vqhx-rx3x) | jwt/ruby-jwt | Empty-key HMAC Bypass | 7.4 | NVD: RESERVED |
| 12 | [CVE-2026-31899](https://nvd.nist.gov/vuln/detail/CVE-2026-31899) | CairoSVG | Exponential DoS — Recursive Amplification | **High (7.5)** | Published |
| 13 | [CVE-2026-44840](https://github.com/dgraph-io/dgraph/security/advisories/GHSA-q2m9-6jp9-c6mc) | Dgraph | DQL Injection via `checkUserPassword` GraphQL Query | **High** | Published |
| 14 | [CVE-2026-33693](https://nvd.nist.gov/vuln/detail/CVE-2026-33693) | activitypub-federation-rust | SSRF — `0.0.0.0` Bypass | Medium (6.5) | Published |
| 15 | [CVE-2026-32885](https://nvd.nist.gov/vuln/detail/CVE-2026-32885) | ddev/ddev | ZipSlip | Medium (6.5) | Published |
| 16 | [CVE-2026-55070](https://github.com/argoproj/argo-workflows/security/advisories/GHSA-rcgr-27rh-g56w) | argoproj/argo-workflows | Informer-cache auth-bypass fix incomplete — Lint/Create endpoints resolve templates without per-caller authorization (CWE-285) | Moderate (5.3) | CVE Assigned |
| 17 | [CVE-2026-55530](https://github.com/MervinPraison/PraisonAI/security/advisories/GHSA-cfxv-8fw8-rwpv) | MervinPraison/PraisonAI | `ast_grep_rewrite` rewrites arbitrary files without `@require_approval` gate (CWE-862) | Moderate (6.1) | Published |
| 18 | [CVE-2026-55528](https://github.com/MervinPraison/PraisonAI/security/advisories/GHSA-7g3p-92qq-8wvh) | MervinPraison/PraisonAI | `AgentServer` declares `auth_token` but never enforces it on any route (CWE-862) | **High (8.2)** | Published |
| 19 | [CVE-2026-49853](https://github.com/tornadoweb/tornado/security/advisories/GHSA-3x9g-8vmp-wqvf) | tornadoweb/tornado | `Authorization` header forwarded across cross-origin redirects in `SimpleAsyncHTTPClient` | **High (7.7)** | Published |
| 20 | [CVE-2026-49353](https://github.com/decolua/9router/security/advisories/GHSA-6g2f-w7g3-77vf) | decolua/9router | Incomplete fix for CVE-2026-46339 — local-only access gate bypass via Host header spoofing (CWE-290) | **High (7.5)** | Published |
| 21 | [CVE-2026-48130](https://github.com/tektoncd/pipeline/security/advisories/GHSA-q6jr-jfqg-8m28) | tektoncd/pipeline | Hub resolver reads HTTP response body via unbounded `io.ReadAll`, enabling DoS via OOM (CWE-770) | Moderate (6.5) | CVE Assigned |
| 22 | [CVE-2026-32809](https://www.cve.org/CVERecord?id=CVE-2026-32809) | ouch (Rust) | Symlink Escape | **High (7.4)** | NVD: RESERVED |
| 23 | [CVE-2026-44217](https://nvd.nist.gov/vuln/detail/CVE-2026-44217) | sse-channel (npm) | SSE Injection — Unsanitized Fields | Moderate | Published |
| 24 | [CVE-2026-48022](https://github.com/advisories/GHSA-x426-x7cc-3fpc) | @hapi/wreck (npm) | Credential Header Leak on Cross-Port / Cross-Scheme Redirect | Moderate | Published |
| 25 | [CVE-2026-46627](https://snailsploit.com/security-research/cves/cve-2026-46627/) | Twig (PHP) | Sandbox Resource Exhaustion — CPU/Memory DoS | Moderate | Published |
| 26 | [CVE-2026-43884](https://nvd.nist.gov/vuln/detail/CVE-2026-43884) | AVideo | SSRF Protection Bypass via DNS Rebinding | **High** | Published |
| 27 | [CVE-2026-45620](https://github.com/advisories/GHSA-vpfx-pxqw-2w79) | AVideo | CVE-2026-43881 Incomplete Fix | — | Published |
| 22 | CVE-2026-45619 | AVideo | CVE-2026-43884 Incomplete Fix — 6+ `isSSRFSafeURL()` sites discard `$resolvedIP` out-param at master HEAD post-`603e7bf` | — | Published |
| 29 | [CVE-2026-3596](https://nvd.nist.gov/vuln/detail/CVE-2026-3596) | Riaxe Product Customizer (WP) | Missing Auth → Priv Esc | **Critical (9.8)** | Published |
| 30 | [CVE-2026-3599](https://nvd.nist.gov/vuln/detail/CVE-2026-3599) | Riaxe Product Customizer (WP) | Unauthenticated SQLi | **High (7.5)** | Published |
| 31 | [CVE-2026-3594](https://nvd.nist.gov/vuln/detail/CVE-2026-3594) | Riaxe Product Customizer (WP) | Info Disclosure — `/orders` | Medium (5.3) | Published |
| 32 | [CVE-2026-3595](https://nvd.nist.gov/vuln/detail/CVE-2026-3595) | Riaxe Product Customizer (WP) | Unauthenticated User Deletion | Medium (5.3) | Published |
| 33 | [CVE-2026-1313](https://nvd.nist.gov/vuln/detail/CVE-2026-1313) | MimeTypes Link Icons (WP) | SSRF | **High (8.3)** | Published |
| 34 | [CVE-2025-9776](https://nvd.nist.gov/vuln/detail/CVE-2025-9776) | CatFolders (WP) | SQLi via CSV Import | Medium (6.5) | Published |
| 35 | [CVE-2025-12163](https://nvd.nist.gov/vuln/detail/CVE-2025-12163) | Omnipress (WP) | Stored XSS | Medium (6.4) | Published |
| 36 | [CVE-2026-2717](https://nvd.nist.gov/vuln/detail/CVE-2026-2717) | HTTP Headers (WP) | CRLF Injection | Medium (5.5) | Published |
| 37 | [CVE-2026-0811](https://nvd.nist.gov/vuln/detail/CVE-2026-0811) | Advanced CF7 DB (WP) | CSRF → Form Deletion | Medium (5.4) | Published |
| 38 | [CVE-2026-0814](https://nvd.nist.gov/vuln/detail/CVE-2026-0814) | Advanced CF7 DB (WP) | Missing Auth — Subscriber+ Export | Medium (4.3) | Published |
| 39 | [CVE-2026-1314](https://nvd.nist.gov/vuln/detail/CVE-2026-1314) | 3D FlipBook (WP) | Missing Auth | Medium (5.3) | Published |
| 40 | [CVE-2025-11171](https://nvd.nist.gov/vuln/detail/CVE-2025-11171) | Chartify (WP) | Missing Auth — Admin Function | Medium (5.3) | Published |
| 41 | [CVE-2025-11174](https://nvd.nist.gov/vuln/detail/CVE-2025-11174) | Document Library Lite (WP) | Missing Auth → Info Disclosure | Medium (5.3) | Published |
| 42 | [CVE-2025-12030](https://nvd.nist.gov/vuln/detail/CVE-2025-12030) | ACF to REST API (WP) | IDOR | Medium (4.3) | Published |
| 43 | [CVE-2026-1208](https://nvd.nist.gov/vuln/detail/CVE-2026-1208) | Welcart (WP) | CSRF → Settings Update | Medium (4.3) | Published |
